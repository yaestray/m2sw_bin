...
class CRaceMotionData
{
	public:
		...
		enum EName
		{
			...
			NAME_KISS_WITH_ELFE = NAME_KISS_START + 5,
			...
			NAME_FRENCH_KISS_WITH_ELFE = NAME_FRENCH_KISS_START + 5,
			...
			NAME_SLAP_HIT_WITH_ELFE = NAME_SLAP_HIT_START + 5,
			...
			NAME_SLAP_HURT_WITH_ELFE = NAME_SLAP_HURT_START + 5,
