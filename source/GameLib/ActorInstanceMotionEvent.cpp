...
#endif
{
	...
	{
#ifdef ENABLE_SKILL_COLOR_SYSTEM
		int iIndex = CEffectManager::Instance().CreateEffect(c_pEffectData->dwEffectIndex, D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), dwSkillColor);
#else
	...
	{
#ifdef ENABLE_SKILL_COLOR_SYSTEM
		AttachEffectByID(0, NULL, c_pEffectData->dwEffectIndex, &c_pEffectData->v3EffectPosition, dwSkillColor);
#else
...
void CActorInstance::ProcessMotionEventUnk12(DWORD dwcurFrame, int iIndex, const CRaceMotionData::TMotionEventData * c_pData)
{
