...
BOOL CActorInstance::isLock()
{
	...
	switch (dwCurMotionIndex)
	{
		...
		case CRaceMotionData::NAME_SELFIE:
		case CRaceMotionData::NAME_DANCE_7:
		case CRaceMotionData::NAME_DOZE:
		case CRaceMotionData::NAME_EXERCISE:
		case CRaceMotionData::NAME_PUSHUP:
		...
		case CRaceMotionData::NAME_KISS_WITH_ELFE:
		...
		case CRaceMotionData::NAME_FRENCH_KISS_WITH_ELFE:
		...
		case CRaceMotionData::NAME_SLAP_HIT_WITH_ELFE:
		...
		case CRaceMotionData::NAME_SLAP_HURT_WITH_ELFE:
