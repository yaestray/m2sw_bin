...
void CMapOutdoor::SpecialEffectShopPos_Create(DWORD dwID, float x, float y, float z, const char* c_szEffName)
{
	CEffectManager& rkEffMgr = CEffectManager::Instance();
	...
	m_kMapShop_dwID_iEffectID.insert(make_pair(dwID, dwEffectID));
}

void CMapOutdoor::SpecialEffectShopPos_Delete(DWORD dwID)
{
	TSpecialEffectMap::iterator itor = m_kMapShop_dwID_iEffectID.find(dwID);
	...
	TraceError("SpecialEffectShopPos_Delete %d %d", dwID, iEffectID);
