...
void CPythonChat::UpdateViewMode(DWORD dwID)
{
	...
	for (itor = pLineList->begin(); itor != pLineList->end();)
	{
		...
		if(pChatLine->ImageImpire)
			pChatLine->ImageImpire->SetPosition(pChatSet->m_ix + 20, pChatSet->m_iy + iHeight + 2);
	}
}
...
void CPythonChat::Render(DWORD dwID)
{
	...
	for (TChatLineList::iterator itor = pLineList->begin(); itor != pLineList->end(); ++itor)
	{
		...
		CGraphicImageInstance *& ipInstance = (*itor)->ImageImpire;
		if (ipInstance)
			ipInstance->Render();
	}
}
...
void CPythonChat::AppendChat(int iType, const char * c_szChat)
{
	...
	for (int i = 0; i < str.length(); i++)
	{
		...
		if (find1 != std::string::npos)
		{
			...
			std::string item_vnumabc = str.substr(pos1, str.length() - pos1);		// |cffffc700|Hitem:12b:1:1:1:0:0:48:25:47:-6|h[Sabie luna plina+9]|h|r 
	...
	CGraphicImageInstance *& prLang = pChatLine->ImageInstance;
	CGraphicImageInstance *& prFlag = pChatLine->ImageImpire;
	...
	if (iType == CHAT_TYPE_SHOUT)
	{
		if (EP1 != std::string::npos)
		{
			...
			if (CResourceManager::Instance().IsFileExist("d:/ymir work/ui/game/flag/ru.tga"))
			{
				CGraphicImage * pLangImage = (CGraphicImage *)CResourceManager::Instance().GetResourcePointer("d:/ymir work/ui/game/flag/ru.tga");
				if (pLangImage)
				{
					prLang = CGraphicImageInstance::New();
					prLang->SetImagePointer(pLangImage);
				}
			}
		}
		else if (EP2 != std::string::npos)
		{
			...
			if (CResourceManager::Instance().IsFileExist("d:/ymir work/ui/game/flag/us.tga"))
			{
				CGraphicImage * pLangImage = (CGraphicImage *)CResourceManager::Instance().GetResourcePointer("d:/ymir work/ui/game/flag/us.tga");
				if (pLangImage)
				{
					prLang = CGraphicImageInstance::New();
					prLang->SetImagePointer(pLangImage);
		...
		else if (EP3 != std::string::npos)
		{
			...
			if (CResourceManager::Instance().IsFileExist("d:/ymir work/ui/game/flag/de.tga"))
			{
				CGraphicImage * pLangImage = (CGraphicImage *)CResourceManager::Instance().GetResourcePointer("d:/ymir work/ui/game/flag/de.tga");
				if (pLangImage)
				{
					prLang = CGraphicImageInstance::New();
					prLang->SetImagePointer(pLangImage);
		...
		else if (EP4 != std::string::npos)
		{

			if (CResourceManager::Instance().IsFileExist("d:/ymir work/ui/game/flag/pl.tga"))
			{
				CGraphicImage * pLangImage = (CGraphicImage *)CResourceManager::Instance().GetResourcePointer("d:/ymir work/ui/game/flag/pl.tga");
				if (pLangImage)
				{
					prLang = CGraphicImageInstance::New();
					prLang->SetImagePointer(pLangImage);
		...
		else if (EP5 != std::string::npos)
		{

			if (CResourceManager::Instance().IsFileExist("d:/ymir work/ui/game/flag/tr.tga"))
			{
				CGraphicImage * pLangImage = (CGraphicImage *)CResourceManager::Instance().GetResourcePointer("d:/ymir work/ui/game/flag/tr.tga");
				if (pLangImage)
				{
					prLang = CGraphicImageInstance::New();
					prLang->SetImagePointer(pLangImage);
		...
		else if (EP9 != std::string::npos)
		{

			if (CResourceManager::Instance().IsFileExist("d:/ymir work/ui/game/flag/ro.tga"))
			{
				CGraphicImage * pLangImage = (CGraphicImage *)CResourceManager::Instance().GetResourcePointer("d:/ymir work/ui/game/flag/ro.tga");
				if (pLangImage)
				{
					prLang = CGraphicImageInstance::New();
					prLang->SetImagePointer(pLangImage);
		...
		else
		{
			...
			if (CResourceManager::Instance().IsFileExist("d:/ymir work/ui/game/flag/netral.tga"))
			{
				CGraphicImage * pLangImage = (CGraphicImage *)CResourceManager::Instance().GetResourcePointer("d:/ymir work/ui/game/flag/netral.tga");
				if (pLangImage)
				{
					prLang = CGraphicImageInstance::New();
					prLang->SetImagePointer(pLangImage);
	...
	if (iType == CHAT_TYPE_SHOUT) {
		...
		else
		{
			...
			if (CResourceManager::Instance().IsFileExist("d:/ymir work/ui/game/flag/netral.tga"))
			{
				CGraphicImage * pFlagImage = (CGraphicImage *)CResourceManager::Instance().GetResourcePointer("d:/ymir work/ui/game/flag/netral.tga");
				if (pFlagImage)
				{
					prFlag = CGraphicImageInstance::New();
					prFlag->SetImagePointer(pFlagImage);
