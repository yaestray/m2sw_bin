...
#endif
		else if (!stricmp(command, "HIDE_SHINING"))
			m_Config.bHideShining = atoi(value) == 1 ? true : false;
#ifdef ENABLE_FOG_FIX
...
#endif
	fprintf(fp, "HIDE_SHINING				%d\n", m_Config.bHideShining);
#ifdef ENABLE_FOG_FIX
