...
PyObject * chrCreateInstance(PyObject* poSelf, PyObject* poArgs)
{
	...
	if (PyTuple_Size(poArgs)==2)
	{
		...
		strncpy(kCreateData.m_szCountry, "us", sizeof(kCreateData.m_szCountry));
...
PyObject * chrIsBoss(PyObject* poSelf, PyObject* poArgs)
{
	int iVirtualID;
	if (!PyTuple_GetInteger(poArgs, 0, &iVirtualID))
		return Py_BuildException();
	...
	return Py_BuildValue("i", pInstance->IsBoss());
}
#endif
...
void initchr()
{
	...
	PyModule_AddIntConstant(poModule, "MOTION_KISS_WITH_ELFE",				CRaceMotionData::NAME_KISS_WITH_ELFE);
	...
	PyModule_AddIntConstant(poModule, "MOTION_FRENCH_KISS_WITH_ELFE",		CRaceMotionData::NAME_FRENCH_KISS_WITH_ELFE);
	...
	PyModule_AddIntConstant(poModule, "MOTION_SLAP_HIT_WITH_ELFE",			CRaceMotionData::NAME_SLAP_HIT_WITH_ELFE);
	...
	PyModule_AddIntConstant(poModule, "MOTION_SLAP_HURT_WITH_ELFE",			CRaceMotionData::NAME_SLAP_HURT_WITH_ELFE);
	...
	PyModule_AddIntConstant(poModule, "MOTION_MODE_POLE",					CRaceMotionData::MODE_POLE);
	PyModule_AddIntConstant(poModule, "MOTION_MODE_HORSE_POLE",				CRaceMotionData::MODE_HORSE_POLE);
	...
	PyModule_AddIntConstant(poModule, "AFFECT_RED_POSSESSION",				CInstanceBase::AFFECT_RED_POSSESION);
	PyModule_AddIntConstant(poModule, "AFFECT_BLUE_POSSESSION",				CInstanceBase::AFFECT_BLUE_POSSESION);
...
#endif
#ifdef ENABLE_ENDLESS_GAIN
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_POTION_1", CInstanceBase::NEW_AFFECT_POTION_1);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_POTION_2", CInstanceBase::NEW_AFFECT_POTION_2);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_POTION_3", CInstanceBase::NEW_AFFECT_POTION_3);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_POTION_4", CInstanceBase::NEW_AFFECT_POTION_4);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_POTION_5", CInstanceBase::NEW_AFFECT_POTION_5);
#endif
	PyModule_AddIntConstant(poModule, "AFFECT_THIRDNORMALSKILL",			CInstanceBase::AFFECT_THIRDNORMALSKILL),
	PyModule_AddIntConstant(poModule, "AFFECT_SOUL_BUFF",					CInstanceBase::AFFECT_SOUL_BUFF);
	PyModule_AddIntConstant(poModule, "AFFECT_KAMIHA",						CInstanceBase::AFFECT_KAMIHA);
