...
enum
{
  ...
  /////////////////////////////////////////////////
	...
	HEADER_CG_TARGET_INFO_LOAD					= 22,
	HEADER_CG_ON_CLICK							= 23,
	HEADER_CG_EXCHANGE							= 24,
    HEADER_CG_CHARACTER_POSITION                = 25,
    HEADER_CG_SCRIPT_ANSWER						= 26,
	HEADER_CG_QUEST_INPUT_STRING				= 27,
    HEADER_CG_QUEST_CONFIRM                     = 28,
	HEADER_CG_PVP								= 29,
    HEADER_CG_SHOP								= 30,
	HEADER_CG_FLY_TARGETING						= 31,
	HEADER_CG_USE_SKILL							= 32,
    HEADER_CG_ADD_FLY_TARGETING                 = 33,
	HEADER_CG_SHOOT								= 34,
	HEADER_CG_MYSHOP                            = 35,
	HEADER_CG_SKILL_COLOR						= 36,
	HEADER_CG_ITEM_USE_TO_ITEM					= 37,
    HEADER_CG_TARGET                            = 38,
	HEADER_CG_WARP								= 39,
    HEADER_CG_SCRIPT_BUTTON						= 40,
    HEADER_CG_MESSENGER                         = 41,
    HEADER_CG_MALL_CHECKOUT                     = 42,
    HEADER_CG_SAFEBOX_CHECKIN                   = 43,
    HEADER_CG_SAFEBOX_CHECKOUT                  = 44,
    HEADER_CG_PARTY_INVITE                      = 45,
    HEADER_CG_PARTY_INVITE_ANSWER               = 46,
    HEADER_CG_PARTY_REMOVE                      = 47,
    HEADER_CG_PARTY_SET_STATE                   = 48,
    HEADER_CG_PARTY_USE_SKILL                   = 49,
    HEADER_CG_SAFEBOX_ITEM_MOVE                 = 50,
	HEADER_CG_PARTY_PARAMETER                   = 51,
	HEADER_CG_GUILD								= 52,
	HEADER_CG_ANSWER_MAKE_GUILD					= 53,
    HEADER_CG_FISHING                           = 54,
    HEADER_CG_GIVE_ITEM                         = 55,
    HEADER_CG_EMPIRE                            = 56,
    HEADER_CG_REFINE                            = 57,
	HEADER_CG_MARK_LOGIN						= 58,
	HEADER_CG_MARK_CRCLIST						= 59,
	HEADER_CG_MARK_UPLOAD						= 60,
	HEADER_CG_MARK_IDXLIST						= 61,
	HEADER_CG_CRC_REPORT						= 62,
	HEADER_CG_HACK								= 63,
    HEADER_CG_CHANGE_NAME                       = 64,
    HEADER_CG_SMS                               = 65,
    HEADER_CG_CHINA_MATRIX_CARD                 = 66,
    HEADER_CG_LOGIN2                            = 67,
	HEADER_CG_DUNGEON							= 68,
	HEADER_CG_LOGIN3							= 69,
	HEADER_CG_GUILD_SYMBOL_UPLOAD				= 70,
	HEADER_CG_GUILD_SYMBOL_CRC					= 71,
	HEADER_CG_SCRIPT_SELECT_ITEM				= 72,
	HEADER_CG_LOGIN4							= 73,
	HEADER_CG_LOGIN5_OPENID						= 74,
	HEADER_CG_CHANGE_LANGUAGE					= 75,
	HEADER_CG_SWITCHBOT							= 76,
	HEADER_CG_RUNUP_MATRIX_ANSWER               = 77,
	HEADER_CG_NEWCIBN_PASSPOD_ANSWER			= 78,
	HEADER_CG_HS_ACK							= 79,
	HEADER_CG_XTRAP_ACK							= 80,
	HEADER_CG_DRAGON_SOUL_REFINE				= 81,
	HEADER_CG_STATE_CHECKER						= 82,
	HEADER_CG_SHOP_SEARCH						= 83,
	HEADER_CG_SHOP_SEARCH_SUB					= 84,
	HEADER_CG_SHOP_SEARCH_BUY					= 85,
	HEADER_CG_SHOP_BUY_NEW						= 86,
	HEADER_CG_GAYA_SELL							= 87,
	HEADER_CG_KEY_AGREEMENT						= 0xfb, // _IMPROVED_PACKET_ENCRYPTION_
	HEADER_CG_TIME_SYNC							= 0xfc,
	HEADER_CG_CLIENT_VERSION					= 0xfd,
	HEADER_CG_CLIENT_VERSION2					= 0xf1,
	HEADER_CG_PONG								= 0xfe,
    HEADER_CG_HANDSHAKE                         = 0xff, //0xff,
	/////////////////////////////////////////////////
   // From Server //////////////////////////////////
  /////////////////////////////////////////////////
	...
	HEADER_GC_LOGIN_SUCCESS4					= 30,
	HEADER_GC_ITEM_UNBIND_TIME					= 31,
	HEADER_GC_WHISPER							= 32,
	HEADER_GC_ALERT								= 33,
	HEADER_GC_MOTION							= 34,
	HEADER_GC_SHOP							    = 35,
	HEADER_GC_SHOP_SIGN							= 36,
	HEADER_GC_DUEL_START						= 37,
	HEADER_GC_PVP								= 38,
	HEADER_GC_EXCHANGE							= 39,
    HEADER_GC_CHARACTER_POSITION                = 40,
	HEADER_GC_PING								= 41,
	HEADER_GC_SCRIPT							= 42,
    HEADER_GC_QUEST_CONFIRM                     = 43,
	HEADER_GC_MOUNT								= 44,
	HEADER_GC_OWNERSHIP                         = 45, 
    HEADER_GC_TARGET                            = 46,
	HEADER_GC_TARGET_INFO						= 47,
	HEADER_GC_SHOPSEARCH_SET					= 48,
	HEADER_GC_WARP								= 49, 
	HEADER_GC_ADD_FLY_TARGETING                 = 50,
	HEADER_GC_CREATE_FLY						= 51,
	HEADER_GC_FLY_TARGETING						= 52,
	HEADER_GC_SKILL_LEVEL						= 53,
	HEADER_GC_SKILL_COOLTIME_END				= 54,
    HEADER_GC_MESSENGER                         = 55,
	HEADER_GC_GUILD								= 56,
	HEADER_GC_SKILL_LEVEL_NEW					= 57,
    HEADER_GC_PARTY_INVITE                      = 58,
    HEADER_GC_PARTY_ADD                         = 59,
    HEADER_GC_PARTY_UPDATE                      = 60,
    HEADER_GC_PARTY_REMOVE                      = 61,
    HEADER_GC_QUEST_INFO                        = 62,
    HEADER_GC_REQUEST_MAKE_GUILD                = 63,
	HEADER_GC_PARTY_PARAMETER                   = 64,
    HEADER_GC_SAFEBOX_MONEY_CHANGE              = 65,
    HEADER_GC_SAFEBOX_SET                       = 66,
    HEADER_GC_SAFEBOX_DEL                       = 67,
    HEADER_GC_SAFEBOX_WRONG_PASSWORD            = 68,
    HEADER_GC_SAFEBOX_SIZE                      = 69,
    HEADER_GC_FISHING                           = 70,
    HEADER_GC_EMPIRE                            = 71,
    HEADER_GC_PARTY_LINK                        = 72,
    HEADER_GC_PARTY_UNLINK                      = 73,
    HEADER_GC_REFINE_INFORMATION                = 74,
	HEADER_GC_OBSERVER_ADD						= 75,
	HEADER_GC_OBSERVER_REMOVE					= 76,
	HEADER_GC_OBSERVER_MOVE						= 77,
	HEADER_GC_VIEW_EQUIP                        = 78,
	HEADER_GC_MARK_BLOCK						= 79,
	HEADER_GC_MARK_DIFF_DATA                    = 80,
	HEADER_GC_MARK_IDXLIST						= 81,
    HEADER_GC_TIME                              = 82,
    HEADER_GC_CHANGE_NAME                       = 83,
	HEADER_GC_DUNGEON							= 84,
	HEADER_GC_WALK_MODE							= 85, 
	HEADER_GC_CHANGE_SKILL_GROUP				= 86,
	HEADER_GC_XTRAP_CS1_REQUEST					= 87,
	HEADER_GC_MAIN_CHARACTER3_BGM				= 88,
	HEADER_GC_MAIN_CHARACTER4_BGM_VOL			= 89,
    HEADER_GC_SEPCIAL_EFFECT                    = 90,
	HEADER_GC_NPC_POSITION						= 91,
    HEADER_GC_CHINA_MATRIX_CARD                 = 92,
    HEADER_GC_CHARACTER_UPDATE2                 = 93,
    HEADER_GC_LOGIN_KEY                         = 94,
    HEADER_GC_REFINE_INFORMATION_NEW            = 95,
    HEADER_GC_CHARACTER_ADD2                    = 96,
    HEADER_GC_CHANNEL                           = 97,
    HEADER_GC_MALL_OPEN                         = 98,
	HEADER_GC_TARGET_UPDATE                     = 99,
	HEADER_GC_TARGET_DELETE                     = 100,
	HEADER_GC_TARGET_CREATE_NEW                 = 101,
	HEADER_GC_SUPPORT_SKILL						= 102,
	HEADER_GC_AFFECT_ADD                        = 103,
	HEADER_GC_AFFECT_REMOVE                     = 104,
    HEADER_GC_MALL_SET                          = 105,
    HEADER_GC_MALL_DEL                          = 106,
	HEADER_GC_LAND_LIST                         = 107,
	HEADER_GC_LOVER_INFO						= 108,
	HEADER_GC_LOVE_POINT_UPDATE					= 109,
	HEADER_GC_GUILD_SYMBOL_DATA					= 110,
    HEADER_GC_DIG_MOTION                        = 111,
	HEADER_GC_DAMAGE_INFO						= 112,
	HEADER_GC_CHAR_ADDITIONAL_INFO				= 113,
	HEADER_GC_ITEM_SET2							= 114,
	HEADER_GC_MAINTENANCE						= 115,
    HEADER_GC_AUTH_SUCCESS                      = 116,
    HEADER_GC_PANAMA_PACK						= 117,
	HEADER_GC_HYBRIDCRYPT_KEYS					= 118,
	HEADER_GC_HYBRIDCRYPT_SDB					= 119,
	HEADER_GC_AUTH_SUCCESS_OPENID				= 120,
	HEADER_GC_SWITCHBOT							= 121,
	HEADER_GC_RUNUP_MATRIX_QUIZ                 = 122,
	HEADER_GC_NEWCIBN_PASSPOD_REQUEST			= 123,
	HEADER_GC_NEWCIBN_PASSPOD_FAILURE			= 124,
	HEADER_GC_ONTIME							= 125,
	HEADER_GC_RESET_ONTIME						= 126,
	HEADER_GC_AUTOBAN_QUIZ						= 127,
	HEADER_GC_HS_REQUEST						= 128,
	HEADER_GC_SPECIFIC_EFFECT					= 129,
	HEADER_GC_DRAGON_SOUL_REFINE				= 130,
	HEADER_GC_RESPOND_CHANNELSTATUS				= 131,
	HEADER_GC_HANDSHAKE_OK						= 132,
	HEADER_GC_MAIN_CHARACTER2_EMPIRE			= 133,
