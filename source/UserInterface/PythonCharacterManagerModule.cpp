...
void initchrmgr()
{
	...
	PyObject * poModule = Py_InitModule("swfucku", s_methods);
	...
	PyModule_AddIntConstant(poModule, "EFFECT_SHINING_WEAPON", CInstanceBase::EFFECT_SHINING_WEAPON);
	PyModule_AddIntConstant(poModule, "EFFECT_SHINING_ARMOR", CInstanceBase::EFFECT_SHINING_ARMOR);
	PyModule_AddIntConstant(poModule, "EFFECT_SHINING_SPECIAL", CInstanceBase::EFFECT_SHINING_SPECIAL);
#endif
