...
const DWORD c_Equipment_Count = 12; //12
...
// 2013년 초에 새로 추가되는 슬롯들은 111 ~ 부터 시작한다. 착용 장비에서 최대로 사용할 수 있는 값은 121 까지이고, 122부터는 용혼석에서 사용한다.
	...
	const DWORD	c_Costume_Slot_Pet = c_Costume_Slot_Start + 4;
	const DWORD c_Costume_Slot_Sash		= c_Costume_Slot_Start + 5;
	const DWORD c_Costume_Slot_Vip		= c_Costume_Slot_Start + 6;
...
const DWORD c_DragonSoul_Equip_Reserved_Count = c_DragonSoul_Equip_Slot_Max * 3;		
	...
	const DWORD c_Inventory_Count	= c_Box_Inventory_Slot_End;
#else
#ifdef ENABLE_NEW_EQUIPMENT_SYSTEM
