...
std::string MULTI_LOCALE_LANG = "us";
...
const char * LocaleService_GetMyLang()
{
	return MULTI_LOCALE_LANG.c_str();
}

void LocaleService_SetMyLang(const char* lang)
{
	MULTI_LOCALE_LANG = lang;
}
...
struct SLOCALEDATA
{
	...
	{ LSS_YMIR,		"ymir",			949,	"testtesttesttest"	},		// Korea //1234abcd5678efgh
	{ LSS_EUROPE,	"de",			1252,	"testtesttesttest"	},		// GameForge (Germany)
	{ LSS_EUROPE,	"en",			1252,	"testtesttesttest"	},		// GameForge (United Kingdom)
	{ LSS_EUROPE,	"us",			1252,	"testtesttesttest"	},		// GameForge (USA)
	{ LSS_EUROPE,	"es",			1252,	"testtesttesttest"	},		// GameForge (Spain)
	{ LSS_EUROPE,	"it",			1252,	"testtesttesttest"	},		// GameForge (Italy)
	{ LSS_EUROPE,	"fr",			1252,	"testtesttesttest"	},		// GameForge (France)
	{ LSS_EUROPE,	"pt",			1252,	"testtesttesttest"	},		// GameForge (Portugal)
	{ LSS_EUROPE,	"tr",			1253,	"testtesttesttest"	},		// GameForge (Greece)
	{ LSS_EUROPE,	"pl",			1250,	"testtesttesttest"	},		// GameForge (Poland)
	{ LSS_EUROPE,	"tr",			1254,	"testtesttesttest"	},		// GameForge (Turkey)
	{ LSS_EUROPE,	"dk",			1252,	"testtesttesttest"	},		// GameForge (Demmark)
	{ LSS_EUROPE,	"ae",			1256,	"testtesttesttest"	},		// GameForge (United Arab Emirate)
	{ LSS_EUROPE,	"mx",			1252,	"testtesttesttest"	},		// GameForge (Mexico)
	{ LSS_EUROPE,	"nl",			1252,	"testtesttesttest"	},		// GameForge (Netherlands)
	{ LSS_EUROPE,	"cz",			1252,	"testtesttesttest"	},		// GameForge (Czech Republic)
	{ LSS_EUROPE,	"ru",			1251,	"testtesttesttest"	},		// GameForge (Russian Federation)
	{ LSS_EUROPE,	"hu",			1250,	"testtesttesttest"	},		// GameForge (Hungary)
	{ LSS_EUROPE,	"ro",			1250,	"testtesttesttest"	},		// GameForge (Romania)
