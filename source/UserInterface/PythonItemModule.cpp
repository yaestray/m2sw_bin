...
void initItem()
{
...
#endif	
	PyModule_AddIntConstant(poModule, "COSTUME_TYPE_VIP",			CItemData::COSTUME_VIP);
	PyModule_AddIntConstant(poModule, "COSTUME_SLOT_VIP",			c_Costume_Slot_Vip);
	...
	PyModule_AddIntConstant(poModule, "WEAPON_POLE",				CItemData::WEAPON_POLE);
	...
	PyModule_AddIntConstant(poModule, "ITEM_ANTIFLAG_ELFE",			CItemData::ITEM_ANTIFLAG_ELFE);
	...
	PyModule_AddIntConstant(poModule, "ANTIFLAG_ELFE",				CItemData::ITEM_ANTIFLAG_ELFE);
	...
	PyModule_AddIntConstant(poModule, "APPLY_RESIST_POLE", CItemData::APPLY_RESIST_POLE);
	PyModule_AddIntConstant(poModule, "APPLY_ATTBONUS_ELFE",		CItemData::APPLY_ATT_BONUS_TO_ELFE);
	PyModule_AddIntConstant(poModule, "APPLY_RESIST_ELFE", CItemData::APPLY_RESIST_ELFE);
}
